class CreateXTables < ActiveRecord::Migration[6.1]
  def change
    ...
    create_table    :x_stocks do |t|
      ...
      t.references  :x_brokers, foreign_key: true
    ...
    ##
    # USE coinpaprika
    # https://api.coinpaprika.com/#tag/Global/paths/~1global/get
    create_table    :x_cryptos do |t|
      t.string      :symbol, null: false

      t.references  :x_crypto_projects, foreign_key: true
